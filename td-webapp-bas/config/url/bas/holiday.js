...
// const objectName = 'holiday';
// const objectNames = 'holidays';
// 基本变量命名标准化、减少代码修改量
export const queryList = `${config.basHost}/${config.basReqType}/${config.basApp}/holidays`;
export const updateType = `${config.basHost}/${config.basReqType}/${config.basApp}/holiday/dayType`;
