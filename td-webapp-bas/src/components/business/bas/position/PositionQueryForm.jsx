    ...
    <Form layout="horizontal" onSubmit={handleSubmit}>
      <Row>
        <Col xs={24} sm={12} md={8}>
          <FormItem label={bizMap.positionname} {...formItemLayout}>
            {
              getFieldDecorator('positionname')(<Input maxLength={75} placeholder={bizMap.positionname} />)
            }
          </FormItem>
        </Col>
        <Col xs={24} sm={12} md={8}>
          <FormItem label={bizMap.positioncode} {...formItemLayout}>
            {
              getFieldDecorator('positioncode')(<Input maxLength={40} placeholder={bizMap.positioncode} />)
            }
          </FormItem>
        </Col>
        <Col xs={24} sm={12} md={8}>
...
PositionQueryForm.propTypes = {
  formSubmit: PropTypes.func,
  addClick: PropTypes.func,
};

PositionQueryForm.defaultProps = {
  formSubmit: noop,
  addClick: noop,
}

export default Form.create()(PositionQueryForm);
