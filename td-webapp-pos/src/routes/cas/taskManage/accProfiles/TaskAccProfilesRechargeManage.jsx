...
import AccountRechargeTable from '../../../../components/business/cas/accTreatment/accountRecharge/AccountRechargeTable';
import TaskAuditHisTable from '../../../../components/business/cas/task/TaskAuditHisTable';
import * as i18n from '../../../../utils/i18n';

const TabPane = Tabs.TabPane;
const TaskAccProfilesRechargeManage = ({ dispatch, taskAccProfilesRechargeManage }) => {
  ...
  const cardProps = {
    title: bizMap.taskAccProfilesRechargeManage,
    style: { width: '100%' },
  };
  const todoQueryFormProps = {
    data: { modeltype: '1304', formReset },
    changeResetData: () => {
      dispatch({
        type: 'taskAccProfilesRechargeManage/updateState',
        payload: { formReset: false },
      });
    },
    formSubmit: (dat) => {
      const queryDat = dat;
      queryDat.modeltype = '1304';
      dispatch({
        type: 'taskAccProfilesRechargeManage/queryTodoList',
  ...
  const myApplyQueryFormProps = {
    ...
    formSubmit: (dat) => {
      ...
      queryDat.modeltype = '1304';
      dispatch({
        type: 'taskAccProfilesRechargeManage/queryMyApplyList',
        payload: { tableParam: { ...queryDat, currentPage: 1 } },
      });
    },
  };
  const myFinishQueryFormProps = {
    ...
    formSubmit: (dat) => {
      ...
      queryDat.modeltype = '1304';
      dispatch({
        type: 'taskAccProfilesRechargeManage/queryMyFinishList',
        payload: { tableParam: { ...queryDat, currentPage: 1 } },
      });
    },
  };
  const infoModalProps = {
    ...
    onCancel: () => {
      dispatch({
        type: 'taskAccProfilesRechargeManage/toggleModal',
  ...
  const updateFormProps = {
    ...
    formSubmitAgree: (dat) => {
      dispatch({
        type: 'taskAccProfilesRechargeManage/updateAgree',
        payload: { ...dat },
      });
    },
    formSubmitReject: (dat) => {
      dispatch({
        type: 'taskAccProfilesRechargeManage/updateReject',
        payload: { ...dat },
      });
    },
  };
  const todoFormProps = {
    ...
    handleAuditHisClick(record) {
      dispatch({
        type: 'taskAccProfilesRechargeManage/queryAuditHis',
        payload: { ...record },
      });
    },
    handleUpdateClick(record) {
      dispatch({
        type: 'taskAccProfilesRechargeManage/beforeUpdate',
        payload: { ...record },
      });
    },
  };
  const myApplyFormProps = {
    ...
    handleDetailClick(record) {
      dispatch({
        type: 'taskAccProfilesRechargeManage/queryOne',
        payload: { ...record },
      });
    },
    handleAuditHisClick(record) {
  ...
  const changeTabPane = (activeKey) => {
    ...
    if (activeKey === '1') {
      dispatch({
        type: 'taskAccProfilesRechargeManage/queryTodoList',
        payload: { tableParam: { modeltype: '1304', currentPage: 1 } },
      });
    } else if (activeKey === '2') {
      dispatch({
        type: 'taskAccProfilesRechargeManage/queryMyFinishList',
  ...
  return (
    <div>
      ...
      <Modal {...infoModalProps}>
        <AccountRechargeTable {...infoTableProps} />
      </Modal>
...
function mapStateToProps({ taskAccProfilesRechargeManage }) {
  return { taskAccProfilesRechargeManage };
}

export default connect(mapStateToProps)(TaskAccProfilesRechargeManage);
