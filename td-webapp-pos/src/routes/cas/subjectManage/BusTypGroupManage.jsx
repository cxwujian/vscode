...
import BusIdInfoForm from '../../../components/business/cas/subjectManage/busTypGroup/BusIdInfoForm';
...
const BusTypGroupManage = ({ dispatch, busTypGroupManage }) => {
  ...
  const {
    ...
    subListModalVisible, busTypData, updateBusIdModalVisible, isReset } = busTypGroupManage;
  const selectIds = [];
  ...
  const subListModalProps = {
    ...
    onCancel: () => {
      dispatch({
        type: 'busTypGroupManage/toggleModal',
        payload: { type: 'updateSubList', data: {}, busTypData: {} },
      });
    },
  };
  ...
  return (
    <div>
      ...
      <Modal {...subListModalProps}>
        <BusIdInfoForm {...busIdTableProps} />
