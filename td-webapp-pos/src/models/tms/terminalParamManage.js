import * as service from '../../services/tms/terminalParam';
import { parseResponse } from '../../utils/request';
import { callNotice } from '../../utils/alert';
import * as i18n from '../../utils/i18n';

// 基础配置信息
const namespace = 'terminalParamManage';
const objectId = 'terId';
const enterPath = '/tms/terminalManage/terminalParamManage';
// 基础公共信息
  ...
  effects: {
    ...
    * queryParmodOptionData({ payload }, { call, put }) {
      ...
      if (detail.rspCod === '200') {
        yield put({
          type: 'updateState',
          payload: { parmodOptionsData: detail.rspList },
        });
      } else {
        callNotice(commonMap.fail, detail.rspMsg || commonMap.failInfo, 'error');
      }
