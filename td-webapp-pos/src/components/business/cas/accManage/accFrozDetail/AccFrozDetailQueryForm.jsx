...
import { Form, Input, Button, Row, Col, Select, InputNumber, DatePicker, Icon } from 'antd';
...
const AccFrozDetailQueryForm = (props) => {
  ...
  const { form, formSubmit, exportClick, advExpand, collapseClick } = props;
