...
import SubjectCodeInfoTable from '../../subjectManage/subjectCode/SubjectCodeInfoTable';
    ...
    <Spin spinning={loading}>
      <Form layout="horizontal">
        ...
        <Row>
          <Col span={24}>
            {
              data.modeltype === '1002' || data.modeltype === '1102' || data.modeltype === '1202' ?
                <SubjectCodeInfoTable data={data.queryMap} />
                :
                null
            }
          </Col>
