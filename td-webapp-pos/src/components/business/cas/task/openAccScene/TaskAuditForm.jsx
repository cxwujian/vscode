...
import OpenAccSceneInfoTable from '../../openAccManage/openAccScene/OpenAccSceneInfoTable';
    ...
    <Spin spinning={loading}>
      <Form layout="horizontal">
        ...
        <Row>
          <Col span={24}>
            {
              data.modeltype === '1010' || data.modeltype === '1110' || data.modeltype === '1210' ?
                <OpenAccSceneInfoTable data={data.queryMap} />
                :
                null
            }
          </Col>
