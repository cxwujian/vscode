...
import TransSubCodeTable from '../../transManage/transBase/TransSubCodeTable';
    ...
    <Spin spinning={loading}>
      <Form layout="horizontal">
        ...
        <Row>
          <Col span={24}>
            {
              data.modeltype === '1007' || data.modeltype === '1107' || data.modeltype === '1207' || data.modeltype === '1307' ?
                <TransSubCodeTable data={data.queryMap} />
                :
                null
            }
          </Col>
