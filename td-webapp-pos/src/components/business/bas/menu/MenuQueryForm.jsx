    ...
    <Form layout="horizontal" onSubmit={handleSubmit}>
      <Row>
        <Col xs={24} sm={12} md={8}>
          <FormItem label={bizMap.menuName} {...formItemLayout}>
            {
              getFieldDecorator('menuName')(<Input maxLength={30} placeholder={bizMap.menuName} />)
            }
          </FormItem>
        </Col>
        <Col xs={24} sm={12} md={8}>
        ...
        <Col xs={24} sm={12} md={8}>
          <FormItem label={bizMap.menuStatus} {...formItemLayout}>
            {
...
export default Form.create()(MenuQueryForm);
