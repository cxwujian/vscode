...
import { Spin, Form, Input, Tree, TreeSelect, Button, Row, Col } from 'antd';
import * as i18n from '../../../../utils/i18n';
import { mobileValid, userRealNameValidate, emailValid } from '../../../../utils/vaild';
            ...
            <FormItem label={bizMap.usrMobile} {...formItemLayout} hasFeedback>
              {
                getFieldDecorator('usrMobile', {
                  ...
                  <Input maxLength={60} placeholder={bizMap.usrMobile} />,
                )
              }
            </FormItem>
          </Col>
