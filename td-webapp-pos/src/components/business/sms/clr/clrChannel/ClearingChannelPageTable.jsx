 ...
 * 渠道清分table list
 */
const ClearingChannelPageTable = (props) => {
  const {
    tableChannelLoading,
    tableChannelList,
    tableChannelTotal,
  ...
  const tableProps = {
    ...
    tableColumns: [
      ...
      {
        title: bizMap.txnTolFee, dataIndex: 'txnTotFee', width: 120, render(text, record) {
          const ccy = ccyMap[record.ccy] || ccyMap.DEFAULT;
          const txt = formatMoney(amtMinUnitToStandUnit(text, record.ccy), 2) + ccy;
          return <span title={txt}>{txt}</span>;
        },
    ...
    scroll: { x: true },
    tableList: tableChannelList,
    tableTotal: tableChannelTotal,
    tableCurrentPage: tableChannelCurrentPage,
    tableLoading: tableChannelLoading,
    tableCheckbox: false,
...
ClearingChannelPageTable.propTypes = {
  tableChannelList: PropTypes.array,
  tableChannelTotal: PropTypes.number,
  tableChannelCurrentPage: PropTypes.number,
  tableChannelLoading: PropTypes.bool,
  tablePageChange: PropTypes.func,
  handleDetailClick: PropTypes.func,
  handleTransactionDetailClick: PropTypes.func,
};

ClearingChannelPageTable.defaultProps = {
  tableChannelList: [],
  tableChannelTotal: 0,
  ...
  handleClearDetailClick: noop,
};

export default ClearingChannelPageTable;
