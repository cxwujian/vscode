 ...
 * 渠道交易table
 */
const ClearingChannelTransactionDetailInfoPageTable = (props) => {
  const {
    chnChannelList,
    chnChannelTotal,
  ...
  const tableProps = {
    ...
    tableColumns: [
      ...
      {
        title: bizMap.ttmerNo, dataIndex: 'ttermNo', width: 120,
      },
      {
        title: bizMap.txnDate, dataIndex: 'txnDate', width: 120, render(text) {
          return date.formatDateString(text);
        },
      },
      {
        title: bizMap.txnTime, dataIndex: 'txnTime', width: 120, render(text) {
          return date.formatDateString(text);
        },
      },
      {
    ...
    scroll: { x: true },
    tableList: chnChannelList,
    tableTotal: chnChannelTotal,
    tableCurrentPage: chnChannelCurrentPage,
    tableLoading: chnChannelLoading,
    tableCheckbox: false,
  ...
  return (<PageTable {...tableProps} scroll={{ x: 1320 }} />);
}

ClearingChannelTransactionDetailInfoPageTable.propTypes = {
  chnChannelList: PropTypes.array,
  chnChannelTotal: PropTypes.number,
  chnChannelCurrentPage: PropTypes.number,
  chnChannelLoading: PropTypes.bool,
  tablePageChange: PropTypes.func,
};

ClearingChannelTransactionDetailInfoPageTable.defaultProps = {
  chnChannelList: [],
  chnChannelTotal: 0,
...
export default ClearingChannelTransactionDetailInfoPageTable;
