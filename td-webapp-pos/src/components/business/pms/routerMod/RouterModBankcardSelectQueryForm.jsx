...
const RouterModBankcardSelectQueryForm = (props) => {
...
RouterModBankcardSelectQueryForm.propTypes = {
  formSubmit: PropTypes.func,
};

RouterModBankcardSelectQueryForm.defaultProps = {
  formSubmit: noop,
}

export default Form.create()(RouterModBankcardSelectQueryForm);
