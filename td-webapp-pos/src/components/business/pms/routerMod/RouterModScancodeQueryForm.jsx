...
const RouterModScancodeQueryForm = (props) => {
...
RouterModScancodeQueryForm.propTypes = {
  formSubmit: PropTypes.func,
  addClick: PropTypes.func,
};

RouterModScancodeQueryForm.defaultProps = {
  formSubmit: noop,
  addClick: noop,
}

export default Form.create()(RouterModScancodeQueryForm);
