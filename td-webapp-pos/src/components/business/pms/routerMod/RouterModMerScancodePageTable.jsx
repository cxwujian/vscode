...
const RouterModMerScancodePageTable = (props) => {
...
RouterModMerScancodePageTable.propTypes = {
...
RouterModMerScancodePageTable.defaultProps = {
  routerTableList: [],
  routerTableTotal: 0,
...
export default RouterModMerScancodePageTable;
