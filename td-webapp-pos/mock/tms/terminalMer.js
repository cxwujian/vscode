...
module.exports = {
  'GET /rest/tms/terminal/mers'(req, res) {
    // 获取请求参数
  ...
  'GET /rest/tms/terminal/mer/12190343142971543550'(req, res) {
     // 获取请求参数
    // 获取请求参数
    const param = qs.parse(Base64.atob(req.query.p));
    console.log('request param =>', param);
  ...
  'GET /rest/tms/terminal/mer/term/05212019881615298560'(req, res) {
     // 获取请求参数
    // 获取请求参数
    const param = qs.parse(Base64.atob(req.query.p));
    console.log('request param =>', param);
  ...
  'GET /rest/tms/terminal/mer/bind/12190343142971543550'(req, res) {
     // 获取请求参数
    // 获取请求参数
    const param = qs.parse(Base64.atob(req.query.p));
    console.log('request param =>', param);
  ...
  'PUT /rest/tms/terminal/mer/12190343142971543550'(req, res) {
    // 获取请求参数
  ...
  'POST /rest/tms/terminal/mer'(req, res) {
    // 获取请求参数
    console.log('request param =>', Base64.atob(req.body));
    const data = mockjs.mock({
      rspCod: '200',
  ...
  'POST /rest/tms/terminal/mers/add'(req, res) {
    // 获取请求参数
    console.log('request param =>', Base64.atob(req.body));
    const data = mockjs.mock({
      rspCod: '200',
  ...
  'DELETE /rest/tms/terminal/mers/unbind'(req, res) {
    // 获取请求参数
    console.log('request param =>', Base64.atob(req.body));
    const data = mockjs.mock({
      rspCod: '200',
