 ...
 * 平台清分form表单
 */
const ClearingPlatformSearchForm = (props) => {
...
ClearingPlatformSearchForm.propTypes = {
  formSubmit: PropTypes.func,
};

ClearingPlatformSearchForm.defaultProps = {
  formSubmit: noop,
};

export default Form.create()(ClearingPlatformSearchForm);
