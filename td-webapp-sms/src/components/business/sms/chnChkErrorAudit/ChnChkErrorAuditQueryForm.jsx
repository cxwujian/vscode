...
const ChnChkErrorAuditQueryForm = (props) => {
...
ChnChkErrorAuditQueryForm.propTypes = {
  formSubmit: PropTypes.func,
};

ChnChkErrorAuditQueryForm.defaultProps = {
  formSubmit: noop,
};

export default Form.create()(ChnChkErrorAuditQueryForm);
