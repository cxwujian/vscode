...
import { Row, Col, Form, Input, Button, Select, Checkbox, Icon } from 'antd';
  ...
  return (
    <Form className={styles.login_form} onSubmit={handleSubmit}>
      ...
      <div className={styles.login_form_content}>
        ...
        {/*<FormItem {...formItemLayout}>
          {
            getFieldDecorator('sysItemMod', {
              initialValue: '0',
              rules: [{
                required: true,
              }],
            })(
              <Select placeholder={commonMap.select} addonBefore={<Icon type="lock" />} >
                <Option value="1">{commonMap.wholeSystemMenus}</Option>
                <Option value="0">{commonMap.subSystemMenus}</Option>
              </Select>,
            )
          }
        </FormItem>*/}
        {/* <FormItem {...formItemLayout}>
          {
            getFieldDecorator('sysMod', {
              initialValue: false,
              rules: [{
                required: true,
              }],
            })(
              <Checkbox defaultChecke={false} size="large" style={{ float: 'right' }}>{commonMap.wholeSystemMenus}</Checkbox>,
            )
          }
        </FormItem> */}
