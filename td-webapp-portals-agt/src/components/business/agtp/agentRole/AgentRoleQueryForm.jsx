...
const AgentRoleQueryForm = (props) => {
    ...
    <Form layout="horizontal" onSubmit={handleSubmit}>
      ...
      <Row>
        <Col sm={24} md={12} style={{ marginBottom: 16 }}>
          <ButtonGroup>
            <Button icon="plus" type="primary" onClick={addOne}>{commonMap.add}</Button>
            <Button type="default" icon="cross" onClick={del}>{commonMap.delete}</Button> &nbsp;
            <Button icon="check" type="default" onClick={enableClick}>{commonMap.enable}</Button>
...
AgentRoleQueryForm.propTypes = {
  formSubmit: PropTypes.func,
  enableClick: PropTypes.func,
  disableClick: PropTypes.func,
};

AgentRoleQueryForm.defaultProps = {
  advExpand: false,
  collapseClick: noop,
  formSubmit: noop,
  enableClick: noop,
...
export default Form.create()(AgentRoleQueryForm);
