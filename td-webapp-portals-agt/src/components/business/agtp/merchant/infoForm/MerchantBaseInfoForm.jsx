...
import { apIDValid, limitNameSpaceValid, postValid, faxValid, phoneValid, mobileValid, codeValid, passportValid } from '../../../../../utils/vaild';
...
const MerchantBaseInfoForm = (props) => {
  ...
  const prefixSelector = getFieldDecorator('merMobileAreaCode', {
            ...
            <FormItem label={bizMap.merMobile} {...formItemLayout} hasFeedback>
              {
                getFieldDecorator('merMobile', {
                  ...
                  <Input addonBefore={prefixSelector} placeholder={bizMap.merMobile} />,
                )
              }
            </FormItem>
          </Col>
            ...
            <FormItem label={bizMap.apId} {...formItemLayout} hasFeedback>
              {
                getFieldDecorator('apId', {
                  ...
                  rules: [{ required: true, message: vaildMap.vaildApId }, getFieldsValue().idType === '03' ? {validator : passportValid} : (getFieldsValue().idType !== '04'?{validator : apIDValid}: {validator : null } )],
                })(
