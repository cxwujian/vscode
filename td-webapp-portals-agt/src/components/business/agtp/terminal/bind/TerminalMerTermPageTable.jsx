...
const TerminalMerTermPageTable = (props) => {
  ...
  const merMap = i18n.bizMap('agtp/terminalMer');
  ...
  const tableProps = {
    ...
    footer: termTableTotal > 0 ? () => { return `${merMap.merName} : ${termTableList[0].terBraName}  ${merMap.merId} : ${termTableList[0].terBraId}`; } : undefined,
  };
...
TerminalMerTermPageTable.propTypes = {
...
TerminalMerTermPageTable.defaultProps = {
...
export default TerminalMerTermPageTable;
