import * as service from '../../services/rms/warnGroup';
...
// 基础配置信息
const namespace = 'warnGroupManage';
const enterPath = '/warnGroup/manage';
...
export default {
  ...
  effects: {
    ...
    * updateOne({ payload }, { call, put }) {
      yield put({
        type: 'updateState',
        payload: { updateFormSubmit: true, loading: true },
      });
    ...
    toggleModal(state, action) {
      ...
      switch (type) {
        case 'add':
          ...
          break;
        case 'update':
          newState = { ...state, updateModalVisible: !state.updateModalVisible, modalFormData: action.payload.dataList };
          break;
        case 'detail':
