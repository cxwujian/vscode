...
module.exports = {
  'GET /rest/oms/order/bankcardOrderHiss'(req, res) {
    // 获取请求参数
  ...
  'PUT /rest/oms/order/bankCardOrderHis/10'(req, res) {
    // 获取请求参数
    const recordList = [];
    const record = {};
    record.txnNo = '20';
  ...
  'PUT /rest/oms/order/bankCardOrderHiss/stats'(req, res) {
    // 获取请求参数
  ...
  'PUT /rest/oms/order/bankCardOrderHis/transferOrder'(req, res) {
    // 获取请求参数
    console.log('request param =>', Base64.atob(req.body));
    const data = mockjs.mock({
      rspCod: '200',
