...
import AgentRoleQueryForm from '../../../components/business/agtp/agentRole/AgentRoleQueryForm';
import AgentRolePageTable from '../../../components/business/agtp/agentRole/AgentRolePageTable'
import AgentRoleInfoTable from '../../../components/business/agtp/agentRole/AgentRoleInfoTable';
import AgentRoleInfoForm from '../../../components/business/agtp/agentRole/infoForm/AgentRoleInfoForm';
import AgentRoleStepForm from '../../../components/business/agtp/agentRole/stepForm/AgentRoleStepForm';
import RoleMenuInfoForm from '../../../components/business/agtp/agentRole/RoleMenuInfoForm';
...
const AgentRoleManage = ({ dispatch, agentRoleManage }) => {
  ...
  const {
    ...
    infoModalVisible, infoTableData, updateModalVisible, roleMenuFormData, roleMenuModalVisible, roleMenuFormSubmit } = agentRoleManage;
  const selectIds = [];
  ...
  const tableProps = {
    ...
    handleQueryRoleMenuClick(record) {
      dispatch({
        type: 'agentRoleManage/queryRoleMenu',
        payload: { ...record },
      });
    },
  };
  ...
  const roleMenuFormProps = {
    ...
    roleAssignFormSubmit: (dat) => {
      ...
      dispatch({
        type: 'agentRoleManage/assignRoleMenu',
        payload: { ...dat },
      });
    },
  };
