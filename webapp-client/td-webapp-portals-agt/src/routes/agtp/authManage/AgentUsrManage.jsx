...
import AgentRoleQueryForm from '../../../components/business/agtp/agentUsr/AgentUsrQueryForm';
import AgentRolePageTable from '../../../components/business/agtp/agentUsr/AgentUsrPageTable';
import AgentRoleInfoTable from '../../../components/business/agtp/agentUsr/AgentUsrInfoTable';
import AgentRoleInfoForm from '../../../components/business/agtp/agentUsr/infoForm/AgentUsrInfoForm';
import AgentRoleStepForm from '../../../components/business/agtp/agentUsr/stepForm/AgentUsrStepForm';
import UserRoleInfoForm from '../../../components/business/agtp/agentUsr/UserRoleInfoForm';
...
const AgentUsrManage = ({ dispatch, agentUsrManage }) => {
  ...
  const {
    advExpand, tableParam, tableLoading, tableList, tableTotal, tableSelects, updateFormSubmit, updateFormData,
     addFormSubmit, addModalVisible, sysInfoList, tableCurrentPage, usrRoleFormSubmit, usrRoleFormData, usrRoleModalVisible,
  ...
  const tableProps = {
    ...
    handleQueryUsrRoleClick(record) {
      dispatch({
        type: 'agentUsrManage/queryUsrRole',
        payload: { ...record },
      });
    },
  };
  ...
  const usrRoleFormProps = {
    ...
    formSubmit: (dat) => {
      dispatch({
        type: 'agentUsrManage/assignUsrRole',
        payload: { ...dat },
      });
    },
  };
