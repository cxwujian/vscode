...
const BankcardOrderInfoTable = (props) => {
  const { data } = props;
  ...
  return (
    <table className="detail_table" style={{ width: 900 }}>
      <tbody>
        ...
        <tr><td colSpan="6" style={{ backgroundColor: '#FFF' }}></td></tr>
        <tr>
...
BankcardOrderInfoTable.propTypes = {
  data: PropTypes.object,
};

BankcardOrderInfoTable.defaultProps = {
  data: {},
}

export default BankcardOrderInfoTable;
