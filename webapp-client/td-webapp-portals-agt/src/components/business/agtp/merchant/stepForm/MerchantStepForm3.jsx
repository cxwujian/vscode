  ...
  const handleSubmit = (ev) => {
    ...
    validateFieldsAndScroll((errors) => {
      if (errors) {
        ...
        dat.FJID_PIC_05, dat.FJID_PIC_06, dat.FJID_PIC_07, dat.FJID_PIC_08, dat.FJID_PIC_09, dat.FJID_PIC_LOGO, dat.FJID_PIC_10, dat.FJID_PIC_11, dat.FJID_PIC_12].toString();
        nextClick(dat);
      }
      resetFields();
    });
