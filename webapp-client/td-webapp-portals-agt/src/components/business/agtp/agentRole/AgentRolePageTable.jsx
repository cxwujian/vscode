...
const AgentRolePageTable = (props) => {
  const { tableCurrentPage, tableList, tableTotal, tableLoading, tablePageChange, tableRowSelect, handleDetailClick, handleQueryRoleMenuClick,
    ...
    tableColumns: [
      ...
      { title: bizMap.updObj, dataIndex: 'updObj' },
      {
        title: commonMap.action, fixed: 'right', width: 180, render(text, record) {
          if (text.roleId === 'ARO000000000000000000') {
            return (
              <span>
