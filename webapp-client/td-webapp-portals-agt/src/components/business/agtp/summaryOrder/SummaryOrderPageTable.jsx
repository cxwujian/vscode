...
const SummaryOrderPageTable = (props) => {
  ...
  const tableProps = {
    ...
    tableColumns: [
      ...
      {
        title: bizMap.payType, dataIndex: 'payType', width: 100, render(text, record) {
          let txt = '';
          switch (text) {
...
SummaryOrderPageTable.propTypes = {
...
SummaryOrderPageTable.defaultProps = {
  tableCurrentPage: 1,
  tableList: [],
  tableTotal: 0,
  tableLoading: false,
...
export default SummaryOrderPageTable;
