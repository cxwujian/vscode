...
const BankcardHisOrderPageTable = (props) => {
...
BankcardHisOrderPageTable.propTypes = {
...
BankcardHisOrderPageTable.defaultProps = {
  tableCurrentPage: 1,
  tableList: [],
  tableTotal: 0,
  tableLoading: false,
...
export default BankcardHisOrderPageTable;
