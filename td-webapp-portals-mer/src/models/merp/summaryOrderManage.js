import * as service from '../../services/merp/summaryOrder';
...
// 基础配置信息
const namespace = 'summaryOrderManage';
const enterPath = '/merp/orderManage/summaryOrderManage';
const commonMap = i18n.commonMap();
const tableLoadFinOpt = {
  type: 'updateState',
  payload: { tableLoading: false },
};
const hisTableLoadFinOpt = {
  type: 'updateState',
  payload: { hisTableLoading: false },
};
export default {
  namespace,
  state: {
