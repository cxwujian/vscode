...
const TaskSubCodeAddManage = ({ dispatch, taskSubCodeAddManage }) => {
  ...
  const cardProps = {
    title: bizMap.taskSubCodeAddManage,
    style: { width: '100%' },
  };
  const todoQueryFormProps = {
    data: { modeltype: '1002', formReset },
    changeResetData: () => {
      dispatch({
        type: 'taskSubCodeAddManage/updateState',
        payload: { formReset: false },
      });
    },
    formSubmit: (dat) => {
      const queryDat = dat;
      queryDat.modeltype = '1002';
      dispatch({
        type: 'taskSubCodeAddManage/queryTodoList',
  ...
  const myApplyQueryFormProps = {
    ...
    formSubmit: (dat) => {
      ...
      queryDat.modeltype = '1002';
      dispatch({
        type: 'taskSubCodeAddManage/queryMyApplyList',
        payload: { tableParam: { ...queryDat, currentPage: 1 } },
      });
    },
  };
  const myFinishQueryFormProps = {
    ...
    formSubmit: (dat) => {
      ...
      queryDat.modeltype = '1002';
      dispatch({
        type: 'taskSubCodeAddManage/queryMyFinishList',
        payload: { tableParam: { ...queryDat, currentPage: 1 } },
      });
    },
  };
  const infoModalProps = {
    ...
    onCancel: () => {
      dispatch({
        type: 'taskSubCodeAddManage/toggleModal',
  ...
  const updateFormProps = {
    ...
    formSubmitAgree: (dat) => {
      dispatch({
        type: 'taskSubCodeAddManage/updateAgree',
        payload: { ...dat },
      });
    },
    formSubmitReject: (dat) => {
      dispatch({
        type: 'taskSubCodeAddManage/updateReject',
        payload: { ...dat },
      });
    },
  };
  const todoFormProps = {
    ...
    handleAuditHisClick(record) {
      dispatch({
        type: 'taskSubCodeAddManage/queryAuditHis',
        payload: { ...record },
      });
    },
    handleUpdateClick(record) {
      dispatch({
        type: 'taskSubCodeAddManage/beforeUpdate',
        payload: { ...record },
      });
    },
  };
  const myApplyFormProps = {
    ...
    handleDetailClick(record) {
      dispatch({
        type: 'taskSubCodeAddManage/queryOne',
        payload: { ...record },
      });
    },
    handleAuditHisClick(record) {
  ...
  const changeTabPane = (activeKey) => {
    ...
    if (activeKey === '1') {
      dispatch({
        type: 'taskSubCodeAddManage/queryTodoList',
        payload: { tableParam: { modeltype: '1002', currentPage: 1 } },
      });
    } else if (activeKey === '2') {
      dispatch({
        type: 'taskSubCodeAddManage/queryMyFinishList',
...
function mapStateToProps({ taskSubCodeAddManage }) {
  return { taskSubCodeAddManage };
}

export default connect(mapStateToProps)(TaskSubCodeAddManage);
