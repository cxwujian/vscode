...
const TaskTxnSubCodeDeleteManage = ({ dispatch, taskTxnSubCodeDeleteManage }) => {
  ...
  const cardProps = {
    title: bizMap.taskTxnSubCodeDeleteManage,
    style: { width: '100%' },
  };
  const todoQueryFormProps = {
    data: { modeltype: '1107', formReset },
    changeResetData: () => {
      dispatch({
        type: 'taskTxnSubCodeDeleteManage/updateState',
        payload: { formReset: false },
      });
    },
    formSubmit: (dat) => {
      const queryDat = dat;
      queryDat.modeltype = '1107';
      dispatch({
        type: 'taskTxnSubCodeDeleteManage/queryTodoList',
  ...
  const myApplyQueryFormProps = {
    ...
    formSubmit: (dat) => {
      ...
      queryDat.modeltype = '1107';
      dispatch({
        type: 'taskTxnSubCodeDeleteManage/queryMyApplyList',
        payload: { tableParam: { ...queryDat, currentPage: 1 } },
      });
    },
  };
  const myFinishQueryFormProps = {
    ...
    formSubmit: (dat) => {
      ...
      queryDat.modeltype = '1107';
      dispatch({
        type: 'taskTxnSubCodeDeleteManage/queryMyFinishList',
        payload: { tableParam: { ...queryDat, currentPage: 1 } },
      });
    },
  };
  const infoModalProps = {
    ...
    onCancel: () => {
      dispatch({
        type: 'taskTxnSubCodeDeleteManage/toggleModal',
  ...
  const updateFormProps = {
    ...
    formSubmitAgree: (dat) => {
      dispatch({
        type: 'taskTxnSubCodeDeleteManage/updateAgree',
        payload: { ...dat },
      });
    },
    formSubmitReject: (dat) => {
      dispatch({
        type: 'taskTxnSubCodeDeleteManage/updateReject',
        payload: { ...dat },
      });
    },
  };
  const todoFormProps = {
    ...
    handleAuditHisClick(record) {
      dispatch({
        type: 'taskTxnSubCodeDeleteManage/queryAuditHis',
        payload: { ...record },
      });
    },
    handleUpdateClick(record) {
      dispatch({
        type: 'taskTxnSubCodeDeleteManage/beforeUpdate',
        payload: { ...record },
      });
    },
  };
  const myApplyFormProps = {
    ...
    handleDetailClick(record) {
      dispatch({
        type: 'taskTxnSubCodeDeleteManage/queryOne',
        payload: { ...record },
      });
    },
    handleAuditHisClick(record) {
  ...
  const changeTabPane = (activeKey) => {
    ...
    if (activeKey === '1') {
      dispatch({
        type: 'taskTxnSubCodeDeleteManage/queryTodoList',
        payload: { tableParam: { modeltype: '1107', currentPage: 1 } },
      });
    } else if (activeKey === '2') {
      dispatch({
        type: 'taskTxnSubCodeDeleteManage/queryMyFinishList',
...
function mapStateToProps({ taskTxnSubCodeDeleteManage }) {
  return { taskTxnSubCodeDeleteManage };
}

export default connect(mapStateToProps)(TaskTxnSubCodeDeleteManage);
