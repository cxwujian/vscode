...
import AccUnfrozDetailTable from '../../../../components/business/cas/accFrozManage/accFrozDetail/AccUnfrozDetailTable';
import TaskAuditHisTable from '../../../../components/business/cas/task/TaskAuditHisTable';
import * as i18n from '../../../../utils/i18n';

const TabPane = Tabs.TabPane;
const TaskAccProfilesUnfreezeManage = ({ dispatch, taskAccProfilesUnfreezeManage }) => {
  ...
  const cardProps = {
    title: bizMap.taskAccProfilesUnfreezeManage,
    style: { width: '100%' },
  };
  const todoQueryFormProps = {
    data: { modeltype: '1204', formReset },
    changeResetData: () => {
      dispatch({
        type: 'taskAccProfilesUnfreezeManage/updateState',
        payload: { formReset: false },
      });
    },
    formSubmit: (dat) => {
      const queryDat = dat;
      queryDat.modeltype = '1204';
      dispatch({
        type: 'taskAccProfilesUnfreezeManage/queryTodoList',
  ...
  const myApplyQueryFormProps = {
    ...
    formSubmit: (dat) => {
      ...
      queryDat.modeltype = '1204';
      dispatch({
        type: 'taskAccProfilesUnfreezeManage/queryMyApplyList',
        payload: { tableParam: { ...queryDat, currentPage: 1 } },
      });
    },
  };
  const myFinishQueryFormProps = {
    ...
    formSubmit: (dat) => {
      ...
      queryDat.modeltype = '1204';
      dispatch({
        type: 'taskAccProfilesUnfreezeManage/queryMyFinishList',
        payload: { tableParam: { ...queryDat, currentPage: 1 } },
      });
    },
  };
  const infoModalProps = {
    ...
    onCancel: () => {
      dispatch({
        type: 'taskAccProfilesUnfreezeManage/toggleModal',
  ...
  const updateFormProps = {
    ...
    formSubmitAgree: (dat) => {
      dispatch({
        type: 'taskAccProfilesUnfreezeManage/updateAgree',
        payload: { ...dat },
      });
    },
    formSubmitReject: (dat) => {
      dispatch({
        type: 'taskAccProfilesUnfreezeManage/updateReject',
        payload: { ...dat },
      });
    },
  };
  const todoFormProps = {
    ...
    handleAuditHisClick(record) {
      dispatch({
        type: 'taskAccProfilesUnfreezeManage/queryAuditHis',
        payload: { ...record },
      });
    },
    handleUpdateClick(record) {
      dispatch({
        type: 'taskAccProfilesUnfreezeManage/beforeUpdate',
        payload: { ...record },
      });
    },
  };
  const myApplyFormProps = {
    ...
    handleDetailClick(record) {
      dispatch({
        type: 'taskAccProfilesUnfreezeManage/queryOne',
        payload: { ...record },
      });
    },
    handleAuditHisClick(record) {
  ...
  const changeTabPane = (activeKey) => {
    ...
    if (activeKey === '1') {
      dispatch({
        type: 'taskAccProfilesUnfreezeManage/queryTodoList',
        payload: { tableParam: { modeltype: '1204', currentPage: 1 } },
      });
    } else if (activeKey === '2') {
      dispatch({
        type: 'taskAccProfilesUnfreezeManage/queryMyFinishList',
  ...
  return (
    <div>
      ...
      <Modal {...infoModalProps}>
        <AccUnfrozDetailTable {...infoTableProps} />
      </Modal>
...
function mapStateToProps({ taskAccProfilesUnfreezeManage }) {
  return { taskAccProfilesUnfreezeManage };
}

export default connect(mapStateToProps)(TaskAccProfilesUnfreezeManage);
