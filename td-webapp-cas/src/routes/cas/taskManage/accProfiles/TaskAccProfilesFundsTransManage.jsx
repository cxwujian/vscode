...
import AccountFundsTransTable from '../../../../components/business/cas/accTreatment/accountFundsTrans/AccountFundsTransTable';
import TaskAuditHisTable from '../../../../components/business/cas/task/TaskAuditHisTable';
import * as i18n from '../../../../utils/i18n';

const TabPane = Tabs.TabPane;
const TaskAccProfilesFundsTransManage = ({ dispatch, taskAccProfilesFundsTransManage }) => {
  ...
  const cardProps = {
    title: bizMap.taskAccProfilesFundsTransManage,
    style: { width: '100%' },
  };
  const todoQueryFormProps = {
    data: { modeltype: '1604', formReset },
    changeResetData: () => {
      dispatch({
        type: 'taskAccProfilesFundsTransManage/updateState',
        payload: { formReset: false },
      });
    },
    formSubmit: (dat) => {
      const queryDat = dat;
      queryDat.modeltype = '1604';
      dispatch({
        type: 'taskAccProfilesFundsTransManage/queryTodoList',
  ...
  const myApplyQueryFormProps = {
    ...
    formSubmit: (dat) => {
      ...
      queryDat.modeltype = '1604';
      dispatch({
        type: 'taskAccProfilesFundsTransManage/queryMyApplyList',
        payload: { tableParam: { ...queryDat, currentPage: 1 } },
      });
    },
  };
  const myFinishQueryFormProps = {
    ...
    formSubmit: (dat) => {
      ...
      queryDat.modeltype = '1604';
      dispatch({
        type: 'taskAccProfilesFundsTransManage/queryMyFinishList',
        payload: { tableParam: { ...queryDat, currentPage: 1 } },
      });
    },
  };
  const infoModalProps = {
    ...
    onCancel: () => {
      dispatch({
        type: 'taskAccProfilesFundsTransManage/toggleModal',
  ...
  const updateFormProps = {
    ...
    formSubmitAgree: (dat) => {
      dispatch({
        type: 'taskAccProfilesFundsTransManage/updateAgree',
        payload: { ...dat },
      });
    },
    formSubmitReject: (dat) => {
      dispatch({
        type: 'taskAccProfilesFundsTransManage/updateReject',
        payload: { ...dat },
      });
    },
  };
  const todoFormProps = {
    ...
    handleAuditHisClick(record) {
      dispatch({
        type: 'taskAccProfilesFundsTransManage/queryAuditHis',
        payload: { ...record },
      });
    },
    handleUpdateClick(record) {
      dispatch({
        type: 'taskAccProfilesFundsTransManage/beforeUpdate',
        payload: { ...record },
      });
    },
  };
  const myApplyFormProps = {
    ...
    handleDetailClick(record) {
      dispatch({
        type: 'taskAccProfilesFundsTransManage/queryOne',
        payload: { ...record },
      });
    },
    handleAuditHisClick(record) {
  ...
  const changeTabPane = (activeKey) => {
    ...
    if (activeKey === '1') {
      dispatch({
        type: 'taskAccProfilesFundsTransManage/queryTodoList',
        payload: { tableParam: { modeltype: '1604', currentPage: 1 } },
      });
    } else if (activeKey === '2') {
      dispatch({
        type: 'taskAccProfilesFundsTransManage/queryMyFinishList',
  ...
  return (
    <div>
      ...
      <Modal {...infoModalProps}>
        <AccountFundsTransTable {...infoTableProps} />
      </Modal>
...
function mapStateToProps({ taskAccProfilesFundsTransManage }) {
  return { taskAccProfilesFundsTransManage };
}

export default connect(mapStateToProps)(TaskAccProfilesFundsTransManage);
