...
const CasTxnJnl = ({ dispatch, casTxnJnl }) => {
  ...
  const {
    tableParam, tableLoading, tableList, tableTotal, tableCurrentPage, tableSelects, infoModalVisible, infoTableData,
    advExpand, amtCountInfo, transBaseOptionsData, ccyOptionsData,
  } = casTxnJnl;
  const selectIds = [];
