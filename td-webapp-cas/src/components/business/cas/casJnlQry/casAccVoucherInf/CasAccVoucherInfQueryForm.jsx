...
const CasAccVoucherInfQueryForm = (props) => {
  ...
  return (
    <Form layout="horizontal" onSubmit={handleSubmit}>
      ...
      <Row style={{ display: advExpand ? 'block' : 'none' }}>
        ...
        <Col xs={24} sm={12} md={8}>
          <FormItem label={bizMap.txnLog} {...formItemLayout}>
            {
              getFieldDecorator('txnLog')(
                <Input placeholder={bizMap.txnLog} />)
            }
          </FormItem>
        </Col>
      </Row>
...
CasAccVoucherInfQueryForm.propTypes = {
...
CasAccVoucherInfQueryForm.defaultProps = {
  formSubmit: noop,
  collapseClick: noop,
  advExpand: false,
...
export default Form.create()(CasAccVoucherInfQueryForm);
