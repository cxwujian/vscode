    ...
    <table className="detail_table">
      <tbody>
        ...
        <tr>
          ...
          <td>{data.ccy}</td>
          <td>{bizMap.accBal}:</td>
          <td>{amtMinUnitToStandUnit(data.accBal, data.ccy)}</td>
        </tr>
        <tr>
          <td>{bizMap.avlAccBal}:</td>
          <td>{amtMinUnitToStandUnit(data.avlAccBal, data.ccy)}</td>
          <td>{bizMap.frozAccAmt}:</td>
          <td>{amtMinUnitToStandUnit(data.frozAccAmt, data.ccy)}</td>
        </tr>
        <tr>
          {
            data.cateId1 ?
