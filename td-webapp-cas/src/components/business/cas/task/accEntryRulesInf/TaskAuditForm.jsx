...
import AccEntryRulesTable from '../../transManage/accEntryRulesInf/AccEntryRulesTable';
    ...
    <Spin spinning={loading}>
      <Form layout="horizontal">
        ...
        <Row>
          <Col span={24}>
            {
              data.modeltype === '1005' || data.modeltype === '1105' || data.modeltype === '1205' ?
                <AccEntryRulesTable data={data.queryMap} />
                :
                null
            }
          </Col>
