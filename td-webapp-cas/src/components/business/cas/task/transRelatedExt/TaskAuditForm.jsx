...
import TransRelatedExtTable from '../../transManage/transRelatedExt/TransRelatedExtTable';
    ...
    <Spin spinning={loading}>
      <Form layout="horizontal">
        ...
        <Row>
          <Col span={24}>
            {
              data.modeltype === '1011' || data.modeltype === '1111' ?
                <TransRelatedExtTable data={data.queryMap} />
                :
                null
            }
          </Col>
