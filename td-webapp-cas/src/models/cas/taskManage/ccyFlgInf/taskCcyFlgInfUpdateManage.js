...
// 基础配置信息
const namespace = 'taskCcyFlgInfUpdateManage';
const objectId = 'id';
const enterPath = '/cas/taskManage/taskCcyFlgInfUpdateManage';
// 基础公共信息
...
export default {
  ...
  state: {
    tableCurrentPage: 1,
    advExpand: false,
    tableParam: { currentPage: 1, modeltype: '1113' },
    tableLoading: false,
    tableList: [],
    tableTotal: 0,
    tableSelects: [],
    ...
    setup({ dispatch, history }) {
      history.listen((location) => {
        if (location.pathname === enterPath) {
          dispatch({ type: 'queryTodoList', payload: { tableParam: { currentPage: 1, modeltype: '1113' } } });
        }
      });
    },
  },
