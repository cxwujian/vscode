...
import { passportValid, apIDValid, limitNameSpaceValid, postValid, faxValid, phoneValid, userRealNameValidate, codeValid, emailValid, merSnameValid } from '../../../../../utils/vaild';
          ...
          <FormItem label={bizMap.apId} {...formItemLayout} hasFeedback required>
            {
              getFieldDecorator('apId', {
                ...
                rules: [{ required: true, message: vaildMap.vaildApId },
                  getFieldsValue().idType === '03' ? {validator : passportValid} : (getFieldsValue().idType !== '04'?{validator : apIDValid}: {validator : null } ) 
                ],
              })(
