...
const enterPath = '/mms/memberApply/merchantApply';
export default {
  namespace,
  state: {
    currentStep: 0,
    idIsBlack: false,
    bankcardIsBlack: false,
    submiting: false,
    form1Data: {},
    form2Data: {},
    form3Data: {},
  ...
  effects: {
    * checkBlackList({ payload },{ call, put, select }){
      yield put({
        type: 'updateState',
      ...
      const res = yield call(service.checkBlackList, { ...submitData });
      const detail = parseResponse(res);
      yield put({
        type: 'updateState',
        payload: { submiting: false, bankcardIsBlack: detail.bankcardIsBlack, idIsBlack: detail.idIsBlack },
      });
