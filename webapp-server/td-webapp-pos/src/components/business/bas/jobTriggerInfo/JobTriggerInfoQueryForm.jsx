...
const JobTriggerInfoQueryForm = (props) => {
...
JobTriggerInfoQueryForm.propTypes = {
  formSubmit: PropTypes.func,
  addClick: PropTypes.func,
  deleteClick: PropTypes.func,
};

JobTriggerInfoQueryForm.defaultProps = {
  formSubmit: noop,
  addClick: noop,
  deleteClick: noop,
}

export default Form.create()(JobTriggerInfoQueryForm);
