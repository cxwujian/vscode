    ...
    validateFieldsAndScroll((errors) => {
      if (errors) {
        ...
        if (dat.braAddress && dat.braAddress.length > 0) {
          dat.braProv = dat.braAddress[0];
          dat.braCity = dat.braAddress[1];
          dat.braArea = dat.braAddress[2];
        }
          ...
          <FormItem label={bizMap.braAddress} {...formItemLayout} hasFeedback>
            {
              getFieldDecorator('braAddress', {
                initialValue: data.braProv ? [data.braProv, data.braCity, data.braArea] : null,
