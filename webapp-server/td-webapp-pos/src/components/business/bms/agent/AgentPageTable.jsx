...
const AgentPageTable = (props) => {
  ...
  const tableProps = {
    ...
    tableColumns: [
      ...
      {
        title: bizMap.agtType, dataIndex: 'agtType', width: 100, render(text) {
          let txt = '';
          switch (text) {
      ...
      {
        title: bizMap.agtScope, dataIndex: 'agtScope', width: 100, render(text) {
          let txt = '';
          switch (text) {
      ...
      {
        title: bizMap.agtStatus, dataIndex: 'agtStatus', width: 100, render(text) {
          let txt = '';
          switch (text) {
