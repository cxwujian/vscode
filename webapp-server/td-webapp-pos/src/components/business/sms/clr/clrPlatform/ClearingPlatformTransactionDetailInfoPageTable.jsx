 ...
 * 渠道交易table
 */
const ClearingPaltformTransactionDetailInfoPageTable = (props) => {
  const {
    chnPlatformList,
    chnPlatformTotal,
  ...
  const tableProps = {
    ...
    scroll: { x: true },
    tableList: chnPlatformList,
    tableTotal: chnPlatformTotal,
    tableCurrentPage: chnPlatformCurrentPage,
    tableLoading: chnPlatformLoading,
    tableCheckbox: false,
...
ClearingPaltformTransactionDetailInfoPageTable.propTypes = {
  chnPlatformList: PropTypes.array,
  chnPlatformTotal: PropTypes.number,
  chnPlatformCurrentPage: PropTypes.number,
  chnPlatformLoading: PropTypes.bool,
  tablePageChange: PropTypes.func,
};

ClearingPaltformTransactionDetailInfoPageTable.defaultProps = {
  chnPlatformList: [],
  chnPlatformTotal: 0,
...
export default ClearingPaltformTransactionDetailInfoPageTable;
