...
const SubjectBalanceQueryForm = (props) => {
...
SubjectBalanceQueryForm.propTypes = {
  formSubmit: PropTypes.func,
  ccyOptionsData: PropTypes.array,
};

SubjectBalanceQueryForm.defaultProps = {
  formSubmit: noop,
  ccyOptionsData: [],
}

export default Form.create()(SubjectBalanceQueryForm);
