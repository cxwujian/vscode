...
const AccountCheckPageTable = (props) => {
  ...
  const tableProps = {
    ...
    tableColumns: [
      ...
      { title: bizMap.subjectAmtTotal, dataIndex: 'subjectAmtTotal', width: 100, render(text) { return cent2Yuan(text); } },
      { title: bizMap.accountAmtTotal, dataIndex: 'accountAmtTotal', width: 100, render(text) { return cent2Yuan(text); } },
      {
