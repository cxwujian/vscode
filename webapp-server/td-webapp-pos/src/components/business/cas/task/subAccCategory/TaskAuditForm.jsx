...
import SubAccCategoryTable from '../../accManage/subAccCategory/SubAccCategoryTable';
    ...
    <Spin spinning={loading}>
      <Form layout="horizontal">
        ...
        <Row>
          <Col span={12}>
            {
              data.modeltype === '1003' || data.modeltype === '1103' ?
                <SubAccCategoryTable data={data.queryMap} />
                :
                null
            }
          </Col>
