...
const MerchantBankcardAuthInfoForm = (props) => {
  const {
    form,
    loading,
    formSubmit,
...
MerchantBankcardAuthInfoForm.propTypes = {
...
MerchantBankcardAuthInfoForm.defaultProps = {
  loading: false,
  formSubmit: noop,
  submiting: false,
  data: {},
...
export default Form.create()(MerchantBankcardAuthInfoForm);
