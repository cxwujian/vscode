...
const PubCountryPageTable = (props) => {
  ...
  const tableProps = {
    ...
    tableColumns: [
      { title: bizMap.country, dataIndex: 'country', width: 200 },
      { title: bizMap.countryCode, dataIndex: 'countryCode', width: 200 },
      { title: bizMap.countryShortName, dataIndex: 'countryShortName', width: 200 },
      {
