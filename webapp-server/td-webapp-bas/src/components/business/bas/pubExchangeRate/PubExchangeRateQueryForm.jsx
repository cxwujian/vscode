...
const PubExchangeRateQueryForm = (props) => {
    ...
    <Form layout="horizontal" onSubmit={handleSubmit}>
      <Row>
        <Col xs={24} sm={12} md={8}>
          <FormItem label={bizMap.fromCurrency} {...formItemLayout}>
            {
              getFieldDecorator('fromCurrency')(<Input placeholder={bizMap.fromCurrency} />)
            }
          </FormItem>
        </Col>
        <Col xs={24} sm={12} md={8}>
...
PubExchangeRateQueryForm.propTypes = {
...
PubExchangeRateQueryForm.defaultProps = {
  formSubmit: noop,
  addClick: noop,
  deleteClick: noop,
  enableClick: noop,
...
export default Form.create()(PubExchangeRateQueryForm);
