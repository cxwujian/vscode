import * as service from '../../services/bas/dubboServices';
import { parseResponse } from '../../utils/request';
import { callNotice } from '../../utils/alert';
import * as i18n from '../../utils/i18n';

// 基础配置信息
const namespace = 'dubboServicesManage';
const objectId = 'dubboServiceId';
const enterPath = '/bas/dubbo/services';
// 基础公共信息
...
export default {
  ...
  reducers: {
    ...
    updateStatusSuccess(state, action) {
      ...
      const dubboServiceStatus = action.payload.dubboServiceStatus;
      const newTableList = state.tableList.map((item) => {
        if (ids.indexOf(item[objectId]) !== -1) {
          return { ...item, dubboServiceStatus: dubboServiceStatus };
        }
        return item;
      });
