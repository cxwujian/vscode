...
const RouterMerScancodePageTable = (props) => {
  ...
  const tableProps = {
    ...
    tableColumns: [
      ...
      {
        title: bizMap.chnMerType, dataIndex: 'chnMerType', width: 150, render(text) {
          let txt = '';
          switch (text) {
...
RouterMerScancodePageTable.propTypes = {
...
RouterMerScancodePageTable.defaultProps = {
  routerTableList: [],
  routerTableTotal: 0,
...
export default RouterMerScancodePageTable;
