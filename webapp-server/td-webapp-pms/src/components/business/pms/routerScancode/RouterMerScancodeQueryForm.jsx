...
const RouterMerScancodeQueryForm = (props) => {
  const bizMap = i18n.bizMap('pms/routerMerScancode');
  const modBizMap = i18n.bizMap('pms/routerMod');
  const commonMap = i18n.commonMap();
  const { form, formSubmit, routerPayloadMerInfo, addClick, ApplyModClick } = props;
...
RouterMerScancodeQueryForm.propTypes = {
  formSubmit: PropTypes.func,
  addClick: PropTypes.func,
  ApplyModClick: PropTypes.func,
};

RouterMerScancodeQueryForm.defaultProps = {
  formSubmit: noop,
  addClick: noop,
  ApplyModClick: noop,
}

export default Form.create()(RouterMerScancodeQueryForm);
