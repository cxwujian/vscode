...
import AccFrozDetailQueryForm from '../../../components/business/cas/accFrozManage/accFrozDetail/AccFrozDetailQueryForm';
import AccFrozDetailPageTable from '../../../components/business/cas/accFrozManage/accFrozDetail/AccFrozDetailPageTable';
import AccFrozDetailForm from '../../../components/business/cas/accFrozManage/accFrozDetail/AccFrozDetailForm';
import AccFrozHandleInfPageTableForm from '../../../components/business/cas/accFrozManage/accFrozDetail/AccFrozHandleInfPageTableForm';
...
const AccFrozDetailManage = ({ dispatch, accFrozDetailManage }) => {
  ...
  const queryFormProps = {
    ...
    querySubjectList(tableParam) {
      const formdata = {};
      dispatch({
        type: 'accFrozDetailManage/querySubjectList',
  ...
  const tableProps = {
    ...
    handleHandleInfListClick(record) {
      dispatch({
        ...
        payload: { handleFormData: record, handleTableParam: { currentPage: 1, busCde: record.busCde }, changeVisible: true },
      });
    },
  };
