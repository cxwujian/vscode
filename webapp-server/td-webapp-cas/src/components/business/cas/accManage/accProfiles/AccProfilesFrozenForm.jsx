...
const AccProfilesFrozenForm = (props) => {
  ...
  const { form, data, loading, submiting, formSubmit, ccyOptionsData } = props;
  ...
  const handleSubmit = (ev) => {
    ...
    validateFieldsAndScroll((errors) => {
      if (errors) {
        ...
        if (data.accBal) {
          dat.accBal = standUnitToMinUnit(dat.accBal, dat.ccy);
        }
        if (data.avlAccBal) {
          dat.avlAccBal = standUnitToMinUnit(dat.avlAccBal, dat.ccy);
        }
        if (data.frozAccAmt) {
          dat.frozAccAmt = standUnitToMinUnit(dat.frozAccAmt, dat.ccy);
        }
        formSubmit(dat);
      }
    });
            ...
            <FormItem label={bizMap.accBal} {...formItemLayout} required>
              {
                getFieldDecorator('accBal', {
                  initialValue: amtMinUnitToStandUnit(data.accBal, data.ccy),
                })(
            ...
            <FormItem label={bizMap.avlAccBal} {...formItemLayout} >
              {
                getFieldDecorator('avlAccBal', {
                  initialValue: amtMinUnitToStandUnit(data.avlAccBal, data.ccy),
                })(
                  <Input placeholder={bizMap.blgSubject} disabled />,
                )
              }
            ...
            <FormItem label={bizMap.frozAccAmt1} {...formItemLayout} >
              {
                getFieldDecorator('frozAccAmt', {
                  initialValue: amtMinUnitToStandUnit(data.frozAccAmt, data.ccy),
                })(
