...
import BusTypGroupAudiPageTable from '../../subjectManage/busTypGroup/BusTypGroupAudiPageTable';
import BusTypGroupInfoTable from '../../subjectManage/busTypGroup/BusTypGroupInfoTable';
...
const TaskAuditForm = (props) => {
  ...
  const { form, data, loading, submiting, formSubmitReject, formSubmitAgree, tableCurrentPage, busIdTableList, busIdTableTotal } = props;
      ...
      <Form layout="horizontal">
        ...
        <Row>
          <Col span={24}>
            {
              data.modeltype === '1001' ?
                <BusTypGroupAudiPageTable tableList={busIdTableList} tableTotal={busIdTableTotal} tableCurrentPage={tableCurrentPage} />
                :
                null
            }
            {
              data.modeltype === '1101' || data.modeltype === '1201' ?
                <BusTypGroupInfoTable data={data.queryMap} />
                :
                null
            }
          </Col>
...
TaskAuditForm.propTypes = {
  ...
  busIdTableList: PropTypes.array,
  busIdTableTotal: PropTypes.object,
  tableCurrentPage: PropTypes.object,
