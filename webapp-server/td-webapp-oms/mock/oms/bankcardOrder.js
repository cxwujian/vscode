...
module.exports = {
  'GET /rest/oms/order/bankcardOrders'(req, res) {
    // 获取请求参数
  ...
  'PUT /rest/oms/order/bankCardOrders/stats'(req, res) {
    // 获取请求参数
  ...
  'PUT /rest/oms/order/bankCardOrder/10'(req, res) {
    // 获取请求参数
    console.log(444)
    const recordList = [];
    const record = {};
  ...
  'PUT /rest/oms/order/bankCardOrder/transferOrder'(req, res) {
    // 获取请求参数
    console.log('request param =>', Base64.atob(req.body));
    const data = mockjs.mock({
      rspCod: '200',
