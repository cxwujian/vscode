 ...
 *  渠道清分表单
 */
const ClearingChannelSearchForm = (props) => {
...
ClearingChannelSearchForm.propTypes = {
  formSubmit: PropTypes.func,
};

ClearingChannelSearchForm.defaultProps = {
  formSubmit: noop,
};

export default Form.create()(ClearingChannelSearchForm);
