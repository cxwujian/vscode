...
class TreeStructure extends React.Component {
  ...
  setContainerWidth(callback) {
    let w = 72 * this.state.leafNum + 20 * (this.state.leafNum - 1);
          ...
          <li key={node[dict.key] + i}>
            {
              columns.length === 0 ?
                <a
                  className="td-tree-structure-node" onContextMenu={this.stopEvent}
